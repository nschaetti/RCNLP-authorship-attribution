...
reutersloader = torch.utils.data.DataLoader(
    datasets.ReutersC50Dataset(root=args.dataset, download=True, n_authors=args.n_authors, dataset_size=args.dataset_size, dataset_start=0),
...
for space in param_space:
    ...
    # Create W if necessary
    if last_rc_size != reservoir_size:
        # Create W matrix
