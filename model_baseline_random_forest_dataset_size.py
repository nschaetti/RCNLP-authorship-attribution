...
args.add_argument(command="--dataset-start", name="dataset_start", type=int,
                  help="Ratio of the data set to use (100 percent by default)", extended=False, default=100)
args.add_argument(command="--dataset-step", name="dataset_step", type=int, help="Dataset step", extended=False,
                  default=1)
...
args.add_argument(command="--analyzer", name="analyzer", type=str, help="word, char, char_wb", extended=False,
                  default='word')
