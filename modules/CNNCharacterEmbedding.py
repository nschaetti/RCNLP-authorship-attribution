...
class CNNCharacterEmbedding(nn.Module):
    """
    CNN Character embedding
    """

    # Constructor
    def __init__(self, voc_size, embedding_dim, n_authors=15, out_channels=(20, 10), kernel_sizes=(5, 5), max_pool_size=2, n_features=30):
        """
        Constructor
        :param n_authors:
        ...
        """
        super(CNNCharacterEmbedding, self).__init__()
